...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.csrf().disable().
		authorizeRequests()
		.antMatchers("/ekisan/buyer/**").hasAnyRole("BUYER")	
		.antMatchers("/ekisan/seller/**").hasRole("SELLER")
		.antMatchers("/home","/ekisan/**").permitAll() //enabling global access to all urls with /api/auth 
